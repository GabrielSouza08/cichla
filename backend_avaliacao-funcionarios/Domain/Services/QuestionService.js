...
QuestionService.prototype.Include = async(req, res, _areaRepository) => {
...
QuestionService.prototype.Get = async(req, res, _areaRepository) => {
    let data = await _areaRepository.Get(req.params.areaId);
    res.json(NotificationTemplate(true, data, "Lista de areas cadastradas!"));
};

QuestionService.prototype.Activate = async(req, res, _areaRepository) => {
...
QuestionService.prototype.Disable = async(req, res, _areaRepository) => {
    let statusDisable = 2;
