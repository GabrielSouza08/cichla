...
ResponsabilityServices.prototype.Include = async(req, res, _userRepository) => {
...
ResponsabilityServices.prototype.Get = async(res, _userRepository) => {
...
ResponsabilityServices.prototype.Update = async(req, res, _userRepository) => {
...
ResponsabilityServices.prototype.Activate = async(req, res, _userRepository) => {
...
ResponsabilityServices.prototype.Disable = async(req, res, _userRepository) => {
    let statusDisable = 2;
...
ResponsabilityServices.prototype.Authenticator = async(req, res, _userRepository) => {
