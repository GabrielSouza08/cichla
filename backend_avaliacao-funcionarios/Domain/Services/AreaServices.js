...
AreaServices.prototype.Include = async(req, res, _userRepository) => {
...
AreaServices.prototype.Get = async(res, _userRepository) => {
...
AreaServices.prototype.Update = async(req, res, _userRepository) => {
...
AreaServices.prototype.Activate = async(req, res, _userRepository) => {
...
AreaServices.prototype.Disable = async(req, res, _userRepository) => {
    let statusDisable = 2;
...
AreaServices.prototype.Authenticator = async(req, res, _userRepository) => {
