...
DepartmentDAO.prototype.GetIdByEmail = async function(email) {
    let conn = new dbConn(true);
...
DepartmentDAO.prototype.GetPermissions = async(id) => {
    let conn = new dbConn(true);
    let query = `SELECT 
    ID_PERMISSAO  		AS id		
...
DepartmentDAO.prototype.Authenticator = async(email) => {
    let conn = new dbConn(true);
...
DepartmentDAO.prototype.Get = async(id) => {
...
DepartmentDAO.prototype.Update = async function(req, isChangePassword) {
    let user = req.body;
...
DepartmentDAO.prototype.ExistenceValidationByEmail = async function(email) {
    let conn = new dbConn(true);
