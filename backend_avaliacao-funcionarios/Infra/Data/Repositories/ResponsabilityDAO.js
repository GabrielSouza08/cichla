...
ResponsabilityDAO.prototype.GetIdByEmail = async function(email) {
    let conn = new dbConn(true);
...
ResponsabilityDAO.prototype.GetPermissions = async(id) => {
    let conn = new dbConn(true);
    let query = `SELECT 
    ID_PERMISSAO  		AS id		
...
ResponsabilityDAO.prototype.Authenticator = async(email) => {
    let conn = new dbConn(true);
...
ResponsabilityDAO.prototype.Get = async(id) => {
...
ResponsabilityDAO.prototype.Update = async function(req, isChangePassword) {
    let user = req.body;
...
ResponsabilityDAO.prototype.ExistenceValidationByEmail = async function(email) {
    let conn = new dbConn(true);
