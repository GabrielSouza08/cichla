...
@Component({
  selector: 'app-formt-dpto',
  templateUrl: './formt-dpto.component.html',
  styleUrls: ['./formt-dpto.component.css']
})
export class FormtDptoComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private collaboratorService: ColaboratorService, private departmentService: DepartmentService, private localService: LocalService, private noteService: NoteService) { }
